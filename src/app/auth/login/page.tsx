/**
 * Login page — the entry point for authenticated users.
 * 
 * This page has two ways to sign in:
 * 1. Email + password (traditional)
 * 2. Google OAuth (click "Sign in with Google" button)
 * 
 * After successful login, Supabase Auth redirects to /auth/callback
 * which then sends the user to /dashboard.
 */
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-lg">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">SubHub</h1>
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
        >
